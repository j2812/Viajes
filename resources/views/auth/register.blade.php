            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="identification_document" class="col-md-4 col-form-label text-md-right">{{ __('Número de identificación') }}</label>

                            <div class="col-md-6">
                                <input id="identification_document" type="text" class="form-control{{ $errors->has('identification_document') ? ' is-invalid' : '' }}" name="identification_document" value="{{ old('identification_document') }}" required>
